...
public final class PreferencesFragment 
  ...
  private CheckBoxPreference bulk;
  ...
  public void onCreate(Bundle icicle) {
    ...
    bulk = (CheckBoxPreference) preferences.findPreference(PreferencesActivity.KEY_BULK_MODE);
  ...
  private void disableLastCheckedPref() {
    Collection<CheckBoxPreference> checked = new ArrayList<CheckBoxPreference>(4);
    ...
    CheckBoxPreference[] checkBoxPreferences = {decode1D, decodeQR, decodeDataMatrix, bulk};

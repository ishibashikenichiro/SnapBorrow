...
public class HttpConnectGetStatus extends AsyncTask<JSONObject, String, JSONObject>
{
	...
	public HttpConnectGetStatus(Activity activity, String url, AsyncTaskListener asyncTaskListener) {
	...
	protected void onPostExecute(JSONObject result) {
		...
		if(_asyncTaskListener != null) {
			_asyncTaskListener.getStatusAsyncTaskCallback(result, requestUrl);
			dialog.dismiss();
		}
	}

...
public class HttpConnectBookRegister extends AsyncTask<JSONArray, String, JSONArray>
{
	...
	public HttpConnectBookRegister(Activity activity, Context context, String url, AsyncTaskListener asyncTaskListener) {
	...
	protected void onPostExecute(JSONArray result) {
		...
		if(_asyncTaskListener != null) {
			_asyncTaskListener.bookRegisterAsyncTaskCallback(result, requestUrl);
			dialog.dismiss();
		}
	}
